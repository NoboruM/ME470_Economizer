...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # create the differnt pages
            # create_nav calls a function that creates the frame
            # first argument is the "parent" 
            # second argument is frame id
            # third argument is frame color
    ...
    def create_frame(self, frame_id, color):
        ...
        # places button in the middle of the screen and prints the color to terminal when pressed
