...
class App(ctk.CTk):
    ...
    def create_input_frame(self, frame_id):
        ...
        self.LL_Lockout_input = ctk.CTkEntry(App.frames[frame_id], placeholder_text=" ", validate="key", validatecommand=num_val, width=input_column_width)
    ...
    def create_download_frame(self, frame_id):
        ...
        self.select_system_button = ctk.CTkButton(App.frames[frame_id], font = self.my_font, text="Select System", command=self.DownloadDataFromPi, corner_radius=50)
